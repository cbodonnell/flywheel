...
func (cpu *ClientPlayerUpdate) InputDismount() bool {
	return cpu.InputX != 0 && cpu.InputJump
}
...
type PlayerStateUpdate struct {
	...
	// FlipH is a flag indicating whether the player is flipped horizontally
...
type NPCStateUpdate struct {
	...
	Velocity kinematic.Vector `json:"velocity"`
	// FlipH is a flag indicating whether NPC is flipped horizontally
	FlipH bool `json:"flipH"`
